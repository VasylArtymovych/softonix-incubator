...
const filteredContacts = computed(() => (
  contacts.value.filter(c => !searchName.value || c.name.toLowerCase().includes(searchName.value.toLowerCase()))
))
...
const handleCurrentChange = (currRow: IContact) => {
  router.push({ name: $routeNames.upsertContact, params: { contactId: currRow.id } })
}
