<template>
  <MainContainer class="md:flex justify-between items-center pt-[50px] pb-4 lg:py-[66px] lg:mt-[37px]">
    ...
    <div class="w-[300px] md:w-[350px]  lg:w-[450px] 2xl:w-[538px] mx-auto md:mx-0">
      ...
      <div
        ref="container"
        class="container w-full flex gap-2 overflow-x-auto snap-x snap-mandatory scrollbar:hidden"
      >
        <div
          v-for="item in 4" :key="item"
          ref="items"
          class="item p-3 lg:p-[30px] bg-white rounded-[14px] shrink-0 w-full snap-start"
        >
