...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    JobOpeningsDepartmentsList: typeof import('./../src/views/job-openings/components/JobOpeningsDepartmentsList.vue')['default']
    JobOpeningsMultiselect: typeof import('./../src/views/job-openings/components/JobOpeningsMultiselect.vue')['default']
    JobOpeningsVacancyList: typeof import('./../src/views/job-openings/components/JobOpeningsVacancyList.vue')['default']
